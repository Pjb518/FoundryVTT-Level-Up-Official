...
import registerCharacterClassesConfig from './config/registerCharacterClassesConfig.ts';
import registerClassesConfig from './config/registerClassesConfig.ts';
import registerConditionsConfig from './config/registerConditionsConfig.ts';
import registerContextsConfig from './config/registerContextsConfig.ts';
import registerDocumentConfig from './config/registerDocumentConfig.ts';
import registerEffectGroupConfig from './config/registerEffectGroupConfig.ts';
import registerEffectLocalizationConfig from './config/registerEffectLocalizationConfig.ts';
...
const areaIcons = {
	none: '<i class="fa-solid fa-times-circle"></i>',
...
const biomes = {
	...
	celestialInfluence: 'A5E.biomes.celestialInfluence',
	coastal: 'A5E.biomes.coastal',
	dragons: 'A5E.biomes.dragons',
	elementalPlaneOfFire: 'A5E.biomes.elementalPlaneOfFire',
	elementalPlaneOfWater: 'A5E.biomes.elementalPlaneOfWater',
	everywhere: 'A5E.biomes.everywhere',
	flowerFields: 'A5E.biomes.flowerFields',
	graveyard: 'A5E.biomes.graveyard',
	heavyAberrationInfluence: 'A5E.biomes.heavyAberrationInfluence',
...
const psionicDisciplines = {
	general: 'A5E.psionicDisciplines.disciplines.general',
	clairsentient: 'A5E.psionicDisciplines.disciplines.clairsentient',
	...
	translocation: 'A5E.psionicDisciplines.disciplines.translocation',
};
...
const scrollData = {
	...
	3: {
		attackBonus: 7,
		cost: { value: 175, denomination: 'gp' },
	...
	4: {
		attackBonus: 7,
		cost: { value: 500, denomination: 'gp' },
		craftingComponent: 'Dire wolf hide',
		saveDC: 15,
		rarity: 'uncommon',
	},
	5: {
		attackBonus: 9,
		cost: { value: 1250, denomination: 'gp' },
	...
	6: {
		attackBonus: 9,
		cost: { value: 3000, denomination: 'gp' },
		craftingComponent: 'Parchment infused with planar energy',
		saveDC: 17,
		rarity: 'rare',
	},
	7: {
		attackBonus: 10,
		cost: { value: 8000, denomination: 'gp' },
	...
	8: {
		attackBonus: 10,
		cost: { value: 20000, denomination: 'gp' },
		craftingComponent: "Blank pages from a lich's spellbook",
		saveDC: 18,
		rarity: 'veryRare',
	},
	9: {
		attackBonus: 11,
		cost: { value: 55000, denomination: 'gp' },
