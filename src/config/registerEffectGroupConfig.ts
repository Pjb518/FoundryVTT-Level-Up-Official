	...
	const effectKeyGroups = {
		abilityChecks: {
			...
			items: [
				...
				'system.abilities.cha.check.maxRoll',
				'system.abilities.cha.check.minRoll',
				'system.abilities.cha.check.rollMode',
				'system.abilities.cha.value',

				'system.abilities.con.check.bonus',
				'system.abilities.con.check.expertiseDice',
				'system.abilities.con.check.maxRoll',
				'system.abilities.con.check.minRoll',
				'system.abilities.con.check.rollMode',
				'system.abilities.con.value',

				'system.abilities.dex.check.bonus',
				'system.abilities.dex.check.expertiseDice',
				'system.abilities.dex.check.maxRoll',
				'system.abilities.dex.check.minRoll',
				'system.abilities.dex.check.rollMode',
				'system.abilities.dex.value',

				'system.abilities.int.check.bonus',
				'system.abilities.int.check.expertiseDice',
				'system.abilities.int.check.maxRoll',
				'system.abilities.int.check.minRoll',
				'system.abilities.int.check.rollMode',
				'system.abilities.int.value',

				'system.abilities.str.check.bonus',
				'system.abilities.str.check.expertiseDice',
				'system.abilities.str.check.maxRoll',
				'system.abilities.str.check.minRoll',
				'system.abilities.str.check.rollMode',
				'system.abilities.str.value',

				'system.abilities.wis.check.bonus',
				'system.abilities.wis.check.expertiseDice',
				'system.abilities.wis.check.maxRoll',
				'system.abilities.wis.check.minRoll',
				'system.abilities.wis.check.rollMode',
		...
		deathSaves: {
			...
			items: [
				...
				'system.rolls.death.expertiseDice',
				'system.rolls.death.maxRoll',
				'system.rolls.death.minRoll',
				'system.rolls.death.rollMode',
		...
		initiative: {
			...
			items: [
				...
				'system.attributes.initiative.maxRoll',
				'system.attributes.initiative.minRoll',
				'system.attributes.initiative.rollMode',
		...
		savingThrows: {
			...
			items: [
				...
				'system.abilities.cha.save.minRoll',
				'system.abilities.cha.save.maxRoll',
				'system.abilities.cha.save.rollMode',
				...
				'system.abilities.con.save.minRoll',
				'system.abilities.con.save.maxRoll',
				'system.abilities.con.save.rollMode',
				'system.abilities.con.save.proficient',

				'system.abilities.dex.save.bonus',
				'system.abilities.dex.save.expertiseDice',
				'system.abilities.dex.save.minRoll',
				'system.abilities.dex.save.maxRoll',
				'system.abilities.dex.save.rollMode',
				'system.abilities.dex.save.proficient',

				'system.abilities.int.save.bonus',
				'system.abilities.int.save.expertiseDice',
				'system.abilities.int.save.minRoll',
				'system.abilities.int.save.maxRoll',
				'system.abilities.int.save.rollMode',
				'system.abilities.int.save.proficient',

				'system.abilities.str.save.bonus',
				'system.abilities.str.save.expertiseDice',
				'system.abilities.str.save.minRoll',
				'system.abilities.str.save.maxRoll',
				'system.abilities.str.save.rollMode',
				'system.abilities.str.save.proficient',

				'system.abilities.wis.save.bonus',
				'system.abilities.wis.save.expertiseDice',
				'system.abilities.wis.save.minRoll',
				'system.abilities.wis.save.maxRoll',
				'system.abilities.wis.save.rollMode',
		...
		skills: {
			...
			items: [
				...
				'system.skills.acr.maxRoll',
				'system.skills.acr.rollMode',
				...
				'system.skills.ani.maxRoll',
				'system.skills.ani.rollMode',
				...
				'system.skills.arc.maxRoll',
				'system.skills.arc.rollMode',
				...
				'system.skills.ath.maxRoll',
				'system.skills.ath.rollMode',
				...
				'system.skills.cul.maxRoll',
				'system.skills.cul.rollMode',
				...
				'system.skills.dec.maxRoll',
				'system.skills.dec.rollMode',
				...
				'system.skills.eng.maxRoll',
				'system.skills.eng.rollMode',
				...
				'system.skills.his.maxRoll',
				'system.skills.his.rollMode',
				...
				'system.skills.ins.maxRoll',
				'system.skills.ins.rollMode',
				...
				'system.skills.itm.maxRoll',
				'system.skills.itm.rollMode',
				...
				'system.skills.inv.maxRoll',
				'system.skills.inv.rollMode',
				...
				'system.skills.med.maxRoll',
				'system.skills.med.rollMode',
				...
				'system.skills.nat.maxRoll',
				'system.skills.nat.rollMode',
				...
				'system.skills.prc.maxRoll',
				'system.skills.prc.rollMode',
				...
				'system.skills.prf.maxRoll',
				'system.skills.prf.rollMode',
				...
				'system.skills.per.maxRoll',
				'system.skills.per.rollMode',
				...
				'system.skills.rel.maxRoll',
				'system.skills.rel.rollMode',
				...
				'system.skills.sci.maxRoll',
				'system.skills.sci.rollMode',
				...
				'system.skills.slt.maxRoll',
				'system.skills.slt.rollMode',
				...
				'system.skills.ste.maxRoll',
				'system.skills.ste.rollMode',
				...
				'system.skills.sur.maxRoll',
				'system.skills.sur.rollMode',
		...
		spellcasting: {
			...
			items: ['system.spellResources.maxPrepared', 'system.attributes.spellDC'],
		},
		spellResources: {
