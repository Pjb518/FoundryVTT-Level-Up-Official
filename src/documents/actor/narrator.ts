...
import type { A5ENarratorData } from '../../dataModels/actor/NarratorDataModel';

// @ts-ignore
export default class NarratorActorA5E extends BaseActorA5e {
  declare system: InstanceType<typeof A5ENarratorData>;
