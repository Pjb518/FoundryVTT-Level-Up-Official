...
class ActorA5E<SubType extends Actor.SubType = Actor.SubType> extends Actor<SubType> {
	...
	async _preCreateChar(
		this: Actor.OfType<'character'>,
		...[_data, _options, _user]: Parameters<Actor['_preCreate']>
	) {
	...
	async _preUpdateCreature(
		this: Creature,
		...[changed, _options, _user]: Parameters<Actor['_preUpdate']>
	) {
	...
	async _preUpdateChar(
		this: Actor.OfType<'character'>,
		...[_changed, _options, _user]: Parameters<Actor['_preUpdate']>
	) {}
	...
	_onCreateChar(
		this: Actor.OfType<'character'>,
		...[_data, _options, userId]: Parameters<Actor['_onCreate']>
	) {
	...
	_onCreateNPC(
		this: Actor.OfType<'npc'>,
		...[_data, _options, _userId]: Parameters<Actor['_onCreate']>
	) {}
	...
	_onUpdateChar(
		this: Actor.OfType<'character'>,
		...[_changed, _options, _userId]: Parameters<Actor['_onUpdate']>
	) {}
