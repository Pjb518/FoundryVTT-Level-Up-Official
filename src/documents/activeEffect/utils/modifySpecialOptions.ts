...
export default function modifySpecialOptions(options: object) {
  ...
  options["flags.a5e.effects.rollMode.attack.all"] = [
    0,
    MODES.OVERRIDE_ONLY,
    ROLL_MODES,
    "RADIO",
  ...
  options["flags.a5e.effects.rollMode.deathSave"] = [
    0,
    MODES.OVERRIDE_ONLY,
    ROLL_MODES,
    "RADIO",
  ];
  options["flags.a5e.effects.rollMode.initiative"] = [
    0,
    MODES.OVERRIDE_ONLY,
    ROLL_MODES,
    "RADIO",
  ...
  options["flags.a5e.effects.damageImmunities.all"] = [
    [],
    MODES.CUSTOM_ONLY,
    null,
    "NONE",
  ];
  options["flags.a5e.effects.damageResistances.all"] = [
    [],
    MODES.CUSTOM_ONLY,
    null,
    "NONE",
  ];
  options["flags.a5e.effects.damageVulnerabilities.all"] = [
    [],
    MODES.CUSTOM_ONLY,
    null,
    "NONE",
  ];
  options["flags.a5e.effects.conditionImmunities.all"] = [
    [],
    MODES.CUSTOM_ONLY,
    null,
    "NONE",
