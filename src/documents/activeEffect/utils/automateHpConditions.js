 ...
 */
export default async function automateHpConditions(
  actor,
  changes,
  userId,
  conditionId,
  ...
  conditionId =
    actor.type === "npc" && conditionId === "unconscious"
      ? "dead"
      : conditionId;
  ...
  const isApplicable =
    conditionId === "bloodied" ? value <= max / 2 && value > 0 : value <= 0;
