  ...
  <div class="u-flex u-flex-col u-gap-md">
      ...
      >
        <div class="u-align-center u-flex u-gap-md">
          <div class="u-align-center u-flex u-gap-md">
            ...
            <label class="u-pointer" for={`${$actor.id}-jack-of-all-trades`}>
    ...
    <FormSection>
      <div class="u-align-center u-flex u-gap-md">
        ...
        <label class="u-pointer" for={`${$actor.id}-track-inventory-weight`}>
      ...
      <FormSection>
        <div class="u-align-center u-flex u-gap-md">
          <div class="u-align-center u-flex u-gap-md">
            ...
            <label class="u-pointer" for={`${$actor.id}-double-carry-capacity`}>
      ...
      >
        <div class="u-align-center u-flex u-gap-md">
          <div class="u-align-center u-flex u-gap-md">
            ...
            <label class="u-pointer" for={`${$actor.id}-track-currency-weight`}>
