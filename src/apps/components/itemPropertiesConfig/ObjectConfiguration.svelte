        ...
        <div class="u-flex u-gap-xxxl u-text-sm u-w-full">
          <div class="u-align-center u-flex u-gap-md">
            <input
              ...
              on:change={({ target }) =>
                updateDocumentDataFromField($item, target.name, target.checked)}
            />
    ...
    <dl class="a5e-box u-flex u-flex-col u-gap-sm u-m-0 u-p-md u-text-sm">
      <div class="u-flex u-gap-md">
        ...
        <dd class="u-m-0 u-p-0">
          {localize(
            CONFIG.A5E.objectTypes[$item.system.objectType] ?? "A5E.None"
          )}
        </dd>
      </div>
      ...
      <div class="u-flex u-gap-md">
        ...
        <dd class="u-m-0 u-p-0">
          {localize(
            CONFIG.A5E.itemRarity[$item.system.rarity] ?? $item.system.rarity
          )}
        </dd>
      </div>
