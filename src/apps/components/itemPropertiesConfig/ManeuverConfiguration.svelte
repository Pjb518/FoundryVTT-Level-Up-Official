  ...
  {#if editMode}
    <div class="u-flex u-flex-col u-gap-md">
      <FormSection heading="A5E.ManeuverDegreePrompt">
        ...
        <RadioGroup
          options={objectEntriesNumberKeyConverter(CONFIG.A5E.maneuverDegrees)}
    ...
    <dl class="a5e-box u-flex u-flex-col u-gap-sm u-m-0 u-p-md u-text-sm">
      ...
      {#if $item.system.degree > 0}
        <div class="u-flex u-gap-md">
          ...
          <dd class="u-m-0 u-p-0">
            {localize(
              CONFIG.A5E.maneuverTraditions[$item.system.tradition] ??
                "A5E.None"
            )}
          </dd>
        </div>
        ...
        <div class="u-flex u-gap-md">
          ...
          <dd class="u-m-0 u-p-0">{$item.system.exertionCost || 0}</dd>
        </div>
      {/if}
    </dl>
  {/if}
