...
declare namespace A5ENarratorData {
...
class A5ENarratorData extends foundry.abstract.TypeDataModel<
  A5ENarratorData.Schema,
  Actor.ConfiguredInstance,
  A5ENarratorData.BaseData,
  A5ENarratorData.DerivedData
> {
  static override defineSchema(): A5ENarratorData.Schema {
    return {
      ...abilities(),
      ...bonuses(),
      ...currency(),
