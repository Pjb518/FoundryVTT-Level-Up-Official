...
export const details = () => ({
	...
	creatureTypes: new fields.ArrayField(new fields.StringField({ required: true, initial: '' }), {
		required: true,
		initial: [],
	}),
});
...
export const proficiencies = () => ({
	proficiencies: new fields.SchemaField({
		armor: new fields.ArrayField(new fields.StringField({ required: true, initial: '' }), {
			required: true,
			initial: [],
		}),
		...
		tools: new fields.ArrayField(new fields.StringField({ required: true, initial: '' }), {
			required: true,
			initial: [],
		}),
		...
		weapons: new fields.ArrayField(new fields.StringField({ required: true, initial: '' }), {
			required: true,
			initial: [],
		}),
	}),
...
export const traits = () => ({
	traits: new fields.SchemaField({
		...
		alignment: new fields.ArrayField(new fields.StringField({ required: true, initial: '' }), {
			required: true,
			initial: [],
		}),
