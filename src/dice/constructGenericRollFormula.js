...
/**
 * A helper function to construct a generic roll formula from an array of component values.
 *
 ...
 */
export default function constructGenericRollFormula({ actor, formula }) {
