...
export class Migration014MigrateSpellBooks extends MigrationBase {
	...
	async updateActor(actorData: Record<string, any>) {
		...
		const showSpellPoints =
			foundry.utils.getProperty(actorData, 'flags.a5e.showSpellPoints') ?? false;
