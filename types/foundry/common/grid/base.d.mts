 ...
 * @abstract
 */
import Color from '../utils/color.d.mts';
...
export default class BaseGrid {
   ...
   */
  constructor({
    size, distance, units, style, thickness, color, alpha
  }: GridConfiguration, ...args: any[]);
  /**
  ...
  getOffsetRange({
    x, y, width, height
  }: Rectangle): [i0: number, j0: number, i1: number, j1: number];
  /**
