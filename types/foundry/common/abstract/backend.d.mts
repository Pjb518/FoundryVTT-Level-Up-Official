/**
 * @typedef {import("./_types.d.mts").DatabaseGetOperation} DatabaseGetOperation
 * @typedef {import("./_types.d.mts").DatabaseCreateOperation} DatabaseCreateOperation
 * @typedef {import("./_types.d.mts").DatabaseUpdateOperation} DatabaseUpdateOperation
 * @typedef {import("./_types.d.mts").DatabaseDeleteOperation} DatabaseDeleteOperation
 */
/**
 ...
 * @abstract
 */
import Document from './document.d.mts';
...
export type DatabaseGetOperation = import('./_types.d.mts').DatabaseGetOperation;
export type DatabaseCreateOperation = import('./_types.d.mts').DatabaseCreateOperation;
export type DatabaseUpdateOperation = import('./_types.d.mts').DatabaseUpdateOperation;
export type DatabaseDeleteOperation = import('./_types.d.mts').DatabaseDeleteOperation;
