/**
 * @typedef {import("./_types.d.mts").DatabaseAction} DatabaseAction
 * @typedef {import("./_types.d.mts").DatabaseOperation} DatabaseOperation
 * @typedef {import("./_types.d.mts").DocumentSocketRequest} DocumentSocketRequest
 */
/**
...
export type DatabaseAction = import('./_types.d.mts').DatabaseAction;
export type DatabaseOperation = import('./_types.d.mts').DatabaseOperation;
export type DocumentSocketRequest = import('./_types.d.mts').DocumentSocketRequest;
