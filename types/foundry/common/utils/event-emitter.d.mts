 ...
 */
export default function EventEmitterMixin<BaseClass extends import("../types.mjs").Constructor>(BaseClass: BaseClass): {
    new (...args: any[]): {
        [x: string]: any;
        /**
...
export type Constructor = import("../types.mjs").Constructor;
